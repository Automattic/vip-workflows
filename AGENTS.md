...
- JSON sequence configurations define stages, transitions, required tools, permissions, and transition inputs (including assignments). Never hardcode an editorial workflow.
