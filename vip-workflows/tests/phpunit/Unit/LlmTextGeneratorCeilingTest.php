...
class LlmTextGeneratorCeilingTest extends TestCase
{
    ...
    private const RESOLVED_ELSEWHERE = array(
        ...
        'self::DRAFT_MAX_TOKENS' => 'vip-workflows/includes/api/class-ideation-controller.php',
        ...
        // below.
        '$bounded_max_tokens'    => 'vip-workflows/includes/abilities/agents/class-stage-agent.php',
    );
