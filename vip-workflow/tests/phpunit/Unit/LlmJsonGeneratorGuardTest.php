...
class LlmJsonGeneratorGuardTest extends TestCase
{
     ...
     */
    private const TEXT_GENERATOR = 'vip-workflow/includes/integrations/class-llm-text-generator.php';

    /**
     * The one file allowed to reach the JSON parser.
     */
    private const JSON_GENERATOR = 'vip-workflow/includes/integrations/class-llm-json-generator.php';
    ...
    private const OPTIONAL_JSON_CHAINS = array(
        'vip-workflow/includes/ideation/assistants/class-llm-assisted-wp-search.php',
    );
