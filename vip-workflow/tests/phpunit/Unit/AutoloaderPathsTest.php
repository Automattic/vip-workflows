 ...
 * in vip-workflow.php on a case-sensitive filesystem (Linux/WPVIP). Without this
...
class AutoloaderPathsTest extends TestCase
{
     ...
     * in vip-workflow.php. Files here are exempt from the class-*.php rule.
     */
    ...
    public function test_filenames_match_class_kebab_convention(): void
    {
        ...
        $this->assertSame(
            ...
            "The custom autoloader in vip-workflow.php expects this convention:\n" .
            implode( "\n", $offenders )
        );
    }
